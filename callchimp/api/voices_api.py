...
class VoicesApi:
    ...
    def voices_list(
        ...
        _param = self._voices_list_serialize(
    ...
    @validate_call
    def voices_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[VoiceResponse]]:
        """List Available Voices
    ...
    @validate_call
    def voices_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
