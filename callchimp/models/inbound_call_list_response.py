...
class InboundCallListResponse(BaseModel):
    ...
    results: Optional[List[InboundCallResponse]] = None
    total_pages: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["count", "current_page", "results", "total_pages"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [InboundCallResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
