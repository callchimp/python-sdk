...
class ListsResponse(BaseModel):
    ...
    isactive: Optional[StrictBool] = None
    isauto: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    organization: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["added_at", "campaign", "description", "id", "isactive", "isauto", "name", "organization"]
