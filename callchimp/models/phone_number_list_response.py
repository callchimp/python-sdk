...
class PhoneNumberListResponse(BaseModel):
    ...
    results: Optional[List[PhoneNumberResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [PhoneNumberResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
