...
class CampaignResponse(BaseModel):
    ...
    bot_language: Optional[StrictStr] = None
    chat_script: Optional[StrictStr] = Field(default=None, description="Script for AI campaigns")
    customer_language: Optional[StrictStr] = Field(default=None, description="Expected language of the leads")
    id: Optional[StrictInt] = None
    is_active: Optional[StrictBool] = None
    is_recording: Optional[StrictBool] = Field(default=None, description="If active for AI campaigns, records all calls")
    ...
    supervisors: Optional[List[StrictInt]] = Field(default=None, description="List of supervisor foreign keys")
    type: Optional[StrictStr] = Field(default=None, description="Type of campaign")
    __properties: ClassVar[List[str]] = ["added_at", "bot_language", "chat_script", "customer_language", "id", "is_active", "is_recording", "max_retry", "name", "organization", "phone_number", "supervisors", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "bot_language": obj.get("bot_language"),
            "chat_script": obj.get("chat_script"),
            "customer_language": obj.get("customer_language"),
            "id": obj.get("id"),
            "is_active": obj.get("is_active"),
            "is_recording": obj.get("is_recording"),
            "max_retry": obj.get("max_retry"),
            "name": obj.get("name"),
            "organization": obj.get("organization"),
            "phone_number": obj.get("phone_number"),
            "supervisors": obj.get("supervisors"),
            "type": obj.get("type")
        })
        return _obj
