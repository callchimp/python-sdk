...
class CampaignListsRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Campaign and list name")
    phone_number: StrictInt = Field(description="Phone number foreign key")
    type: StrictStr
    transaction_template: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "phone_number", "type", "transaction_template", "description"]
