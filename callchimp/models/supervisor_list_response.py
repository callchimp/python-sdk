...
class SupervisorListResponse(BaseModel):
    ...
    results: Optional[List[SupervisorResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SupervisorResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
