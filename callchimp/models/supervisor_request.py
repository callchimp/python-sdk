...
class SupervisorRequest(BaseModel):
    ...
    SupervisorRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the supervisor")
    phone: StrictStr = Field(description="[E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number of supervisor. ")
    priority: StrictInt = Field(description="Priority of supervisor in the queue")
    organization: Optional[StrictInt] = Field(default=None, description="Current organization id. Can be found in the Callchimp [Settings](https://callchimp.ai/settings) -> Organization tab -> Org ID Column.")
    __properties: ClassVar[List[str]] = ["name", "phone", "priority", "organization"]
