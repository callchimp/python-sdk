...
class WebhookListResponse(BaseModel):
    ...
    results: Optional[List[WebhookResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [WebhookResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
