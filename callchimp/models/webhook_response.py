...
class WebhookResponse(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="For campaign type webhooks, `campaign` key is required.")
    updated_at: Optional[datetime] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["added_at", "campaign", "id", "name", "organization", "request_headers", "type", "updated_at", "url"]
