...
class TransactionCallRequestByLeadId(BaseModel):
    """
    TransactionCallRequestByLeadId
    """ # noqa: E501
    lead: StrictInt = Field(description="Lead Id")
    transaction_audio_gender: Optional[StrictStr] = Field(default=None, description="Gender of the generated voice")
    transaction_vars: Dict[str, Any] = Field(description="Transaction variable values that should match the variables in campaign `transaction_template`")
    __properties: ClassVar[List[str]] = ["lead", "transaction_audio_gender", "transaction_vars"]

    @field_validator('transaction_audio_gender')
    def transaction_audio_gender_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lead": obj.get("lead"),
            "transaction_audio_gender": obj.get("transaction_audio_gender"),
            "transaction_vars": obj.get("transaction_vars")
        })
        return _obj
