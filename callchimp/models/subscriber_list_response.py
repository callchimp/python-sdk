...
class SubscriberListResponse(BaseModel):
    ...
    results: Optional[List[SubscriberResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [SubscriberResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
