...
class ScriptRequest(BaseModel):
    ...
    script: Optional[StrictStr] = Field(default=None, description="Script the bot should follow during the conversation")
    __properties: ClassVar[List[str]] = ["name", "script"]
