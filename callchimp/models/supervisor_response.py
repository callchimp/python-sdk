...
class SupervisorResponse(BaseModel):
    ...
    otp: Optional[StrictInt] = None
    otp_created_at: Optional[datetime] = None
    otp_verified: Optional[StrictBool] = None
    phone: Optional[StrictStr] = None
    priority: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["added_at", "id", "name", "organization", "otp", "otp_created_at", "otp_verified", "phone", "priority"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "otp": obj.get("otp"),
            "otp_created_at": obj.get("otp_created_at"),
            "otp_verified": obj.get("otp_verified"),
            "phone": obj.get("phone"),
