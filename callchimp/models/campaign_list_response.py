...
class CampaignListResponse(BaseModel):
    ...
    results: Optional[List[CampaignResponse]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "results": [CampaignResponse.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None,
