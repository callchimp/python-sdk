...
SUBSCRIBERSPOST200RESPONSE_ANY_OF_SCHEMAS = ["List[SubscriberResponse]", "SubscriberResponse"]

class SubscribersPost200Response(BaseModel):
    """
    SubscribersPost200Response
    """

    # data type: SubscriberResponse
    anyof_schema_1_validator: Optional[SubscriberResponse] = None
    # data type: List[SubscriberResponse]
    anyof_schema_2_validator: Optional[List[SubscriberResponse]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[SubscriberResponse], SubscriberResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[SubscriberResponse]", "SubscriberResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = SubscribersPost200Response.model_construct()
        error_messages = []
        # validate data type: SubscriberResponse
        if not isinstance(v, SubscriberResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SubscriberResponse`")
        else:
            return v

        # validate data type: List[SubscriberResponse]
        try:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in SubscribersPost200Response with anyOf schemas: List[SubscriberResponse], SubscriberResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[SubscriberResponse] = None
        try:
            instance.actual_instance = SubscriberResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # deserialize data into List[SubscriberResponse]
        try:
            # validation
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SubscribersPost200Response with anyOf schemas: List[SubscriberResponse], SubscriberResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[SubscriberResponse], SubscriberResponse]]:
