...
from callchimp.api_response import ApiResponse, T as ApiResponseT
import callchimp.models
from callchimp import rest
from callchimp.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(callchimp.models, klass)
