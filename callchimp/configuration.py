...
conf = callchimp.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.callchimp.ai/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("callchimp")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.callchimp.ai/v1",
                'description': "Callchimp Production",
            },
            {
                'url': "https://api.callchimp.ai/dev",
                'description': "Callchimp Staging",
            }
        ]
