...
------------- | ------------- | -------------
[**delete_dev_webhooks42**](WebhooksApi.md#delete_dev_webhooks42) | **DELETE** /webhooks/{Id} | Delete Webhook by Id
[**patch_dev_webhooks41**](WebhooksApi.md#patch_dev_webhooks41) | **PATCH** /webhooks/{Id} | Update Webhook by Id
[**post_dev_webhooks**](WebhooksApi.md#post_dev_webhooks) | **POST** /webhooks | Create a Webhook
...
# **delete_dev_webhooks42**
> delete_dev_webhooks42(id)
...
with callchimp.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Webhook by Id
        api_instance.delete_dev_webhooks42(id)
    except Exception as e:
        print("Exception when calling WebhooksApi->delete_dev_webhooks42: %s\n" % e)
```
...
# **patch_dev_webhooks41**
> WebhookResponse patch_dev_webhooks41(id, webhook_request)
...
with callchimp.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Webhook by Id
        api_response = api_instance.patch_dev_webhooks41(id, webhook_request)
        print("The response of WebhooksApi->patch_dev_webhooks41:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebhooksApi->patch_dev_webhooks41: %s\n" % e)
```
...
# **post_dev_webhooks**
> WebhookResponse post_dev_webhooks(webhook_request)
...
with callchimp.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = callchimp.WebhooksApi(api_client)
    webhook_request = {"campaign":539,"name":"Test Webhook krakend campaign","type":"campaign","url":"https://eosvk50trch971z.m.pipedream.net"} # WebhookRequest | 

    try:
        # Create a Webhook
        api_response = api_instance.post_dev_webhooks(webhook_request)
        print("The response of WebhooksApi->post_dev_webhooks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WebhooksApi->post_dev_webhooks: %s\n" % e)
```
