...
class TestListsListResponse(unittest.TestCase):
    """ListsListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListsListResponse:
        """Test ListsListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListsListResponse`
        """
        model = ListsListResponse()
        if include_optional:
            return ListsListResponse(
                count = 56,
                current_page = 56,
                results = [
                    callchimp.models.lists_response.ListsResponse(
    ...
    def testListsListResponse(self):
        """Test ListsListResponse"""
