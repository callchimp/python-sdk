...
class TestCallReportResponseAnsweredCalls(unittest.TestCase):
    """CallReportResponseAnsweredCalls unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallReportResponseAnsweredCalls:
        """Test CallReportResponseAnsweredCalls
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallReportResponseAnsweredCalls`
        """
        model = CallReportResponseAnsweredCalls()
        if include_optional:
            return CallReportResponseAnsweredCalls(
                current = 56,
                past = 56
            )
        else:
    ...
    def testCallReportResponseAnsweredCalls(self):
        """Test CallReportResponseAnsweredCalls"""
