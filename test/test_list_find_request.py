...
class TestListFindRequest(unittest.TestCase):
    """ListFindRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFindRequest:
        """Test ListFindRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFindRequest`
        """
        model = ListFindRequest()
        if include_optional:
            return ListFindRequest(
                query = ''
            )
        else:
            return ListFindRequest(
