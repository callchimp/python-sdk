...
class TestScriptRequest(unittest.TestCase):
    """ScriptRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScriptRequest:
        """Test ScriptRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScriptRequest`
        """
        model = ScriptRequest()
        if include_optional:
