...
class TestScriptListResponse(unittest.TestCase):
    """ScriptListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScriptListResponse:
        """Test ScriptListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScriptListResponse`
        """
        ...
        if include_optional:
            return ScriptListResponse(
                ...
                current_page = 56,
                results = [
                    callchimp.models.script_response.ScriptResponse(
                        ...
                        explanation = '', 
                        final_rating = '', 
                        harm_category_dangerous_content_score = 56, 
                        harm_category_harassment_score = 56, 
                        harm_category_hate_speech_score = 56, 
                        harm_category_sexually_explicit_score = 56, 
                        id = 56, 
                        name = '', 
                        organization = 56, 
                        script = '', )
    ...
    def testScriptListResponse(self):
        """Test ScriptListResponse"""
