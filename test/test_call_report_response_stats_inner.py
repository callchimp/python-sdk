...
class TestCallReportResponseStatsInner(unittest.TestCase):
    """CallReportResponseStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallReportResponseStatsInner:
        """Test CallReportResponseStatsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallReportResponseStatsInner`
        """
        model = CallReportResponseStatsInner()
        if include_optional:
            return CallReportResponseStatsInner(
    ...
    def testCallReportResponseStatsInner(self):
        """Test CallReportResponseStatsInner"""
