...
class TestInboundCallListResponse(unittest.TestCase):
    """InboundCallListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundCallListResponse:
        """Test InboundCallListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundCallListResponse`
        """
        model = InboundCallListResponse()
        if include_optional:
            return InboundCallListResponse(
                count = 56,
                current_page = 56,
                results = [
                    callchimp.models.inbound_call_response.InboundCallResponse(
                        callchimp_number = callchimp.models.inbound_call_response_callchimp_number.InboundCallResponse_callchimp_number(
                            id = 56, 
                            number = '', 
                            type = 'JIO', ), 
                        ...
                        is_answered = True, 
                        organization = 56, 
                        supervisor = callchimp.models.inbound_call_response_supervisor.InboundCallResponse_supervisor(
                            id = 56, 
                            name = '', 
                            phone = '', 
                            priority = 56, ), 
    ...
    def testInboundCallListResponse(self):
        """Test InboundCallListResponse"""
