...
class TestSubscriberResponse(unittest.TestCase):
    """SubscriberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriberResponse:
        """Test SubscriberResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriberResponse`
        """
    ...
    def testSubscriberResponse(self):
        """Test SubscriberResponse"""
