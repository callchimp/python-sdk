...
class TestSupervisorRequest(unittest.TestCase):
    """SupervisorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorRequest:
        """Test SupervisorRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorRequest`
        """
    ...
    def testSupervisorRequest(self):
        """Test SupervisorRequest"""
