...
class TestSupervisorResponse(unittest.TestCase):
    """SupervisorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorResponse:
        """Test SupervisorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorResponse`
        """
    ...
    def testSupervisorResponse(self):
        """Test SupervisorResponse"""
