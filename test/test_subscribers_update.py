...
class TestSubscribersUpdate(unittest.TestCase):
    """SubscribersUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscribersUpdate:
        """Test SubscribersUpdate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscribersUpdate`
        """
        model = SubscribersUpdate()
        if include_optional:
            return SubscribersUpdate(
                first_name = ''
            )
        else:
            return SubscribersUpdate(
    ...
    def testSubscribersUpdate(self):
        """Test SubscribersUpdate"""
