...
class TestSupervisorVerifyOtpRequest(unittest.TestCase):
    """SupervisorVerifyOtpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorVerifyOtpRequest:
        """Test SupervisorVerifyOtpRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorVerifyOtpRequest`
        """
        model = SupervisorVerifyOtpRequest()
        if include_optional:
            return SupervisorVerifyOtpRequest(
                otp = ''
            )
        else:
            return SupervisorVerifyOtpRequest(
    ...
    def testSupervisorVerifyOtpRequest(self):
        """Test SupervisorVerifyOtpRequest"""
