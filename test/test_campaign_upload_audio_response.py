...
class TestCampaignUploadAudioResponse(unittest.TestCase):
    """CampaignUploadAudioResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignUploadAudioResponse:
        """Test CampaignUploadAudioResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignUploadAudioResponse`
        """
        model = CampaignUploadAudioResponse()
        if include_optional:
            return CampaignUploadAudioResponse(
                message = ''
            )
        else:
            return CampaignUploadAudioResponse(
    ...
    def testCampaignUploadAudioResponse(self):
        """Test CampaignUploadAudioResponse"""
