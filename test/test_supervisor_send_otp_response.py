...
class TestSupervisorSendOtpResponse(unittest.TestCase):
    """SupervisorSendOtpResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorSendOtpResponse:
        """Test SupervisorSendOtpResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorSendOtpResponse`
        """
        model = SupervisorSendOtpResponse()
        if include_optional:
            return SupervisorSendOtpResponse(
                message = ''
            )
        else:
            return SupervisorSendOtpResponse(
    ...
    def testSupervisorSendOtpResponse(self):
        """Test SupervisorSendOtpResponse"""
