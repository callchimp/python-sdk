...
class TestCallReportResponse(unittest.TestCase):
    """CallReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallReportResponse:
        """Test CallReportResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallReportResponse`
        """
        model = CallReportResponse()
        if include_optional:
            return CallReportResponse(
                answered_calls = callchimp.models.call_report_response_answered_calls.CallReportResponse_answered_calls(
                    current = 56, 
                    past = 56, ),
                campaigns_count = 56,
                queued_calls = callchimp.models.call_report_response_answered_calls.CallReportResponse_answered_calls(
                    current = 56, 
                    past = 56, ),
                stats = [
                    callchimp.models.call_report_response_stats_inner.CallReportResponse_stats_inner(
                        date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        total = 56, )
                    ],
                total_calls = callchimp.models.call_report_response_answered_calls.CallReportResponse_answered_calls(
                    current = 56, 
                    past = 56, ),
                total_duration = callchimp.models.call_report_response_answered_calls.CallReportResponse_answered_calls(
                    current = 56, 
                    past = 56, )
            )
        else:
    ...
    def testCallReportResponse(self):
        """Test CallReportResponse"""
