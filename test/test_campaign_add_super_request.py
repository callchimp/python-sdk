...
class TestCampaignAddSuperRequest(unittest.TestCase):
    """CampaignAddSuperRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignAddSuperRequest:
        """Test CampaignAddSuperRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignAddSuperRequest`
        """
        model = CampaignAddSuperRequest()
        if include_optional:
            return CampaignAddSuperRequest(
                supervisors = [
                    56
                    ]
            )
    ...
    def testCampaignAddSuperRequest(self):
        """Test CampaignAddSuperRequest"""
