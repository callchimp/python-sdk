...
class TestSubscriberRequest(unittest.TestCase):
    """SubscriberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriberRequest:
        """Test SubscriberRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriberRequest`
        """
    ...
    def testSubscriberRequest(self):
        """Test SubscriberRequest"""
