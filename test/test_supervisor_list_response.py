...
class TestSupervisorListResponse(unittest.TestCase):
    """SupervisorListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorListResponse:
        """Test SupervisorListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorListResponse`
        """
        model = SupervisorListResponse()
        if include_optional:
            return SupervisorListResponse(
                count = 56,
                current_page = 56,
                results = [
                    callchimp.models.supervisor_response.SupervisorResponse(
                        added_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        id = 56, 
                        name = '', 
                        organization = 56, 
                        otp = 56, 
                        otp_created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        otp_verified = True, 
                        phone = '', 
                        priority = 56, )
                    ],
    ...
    def testSupervisorListResponse(self):
        """Test SupervisorListResponse"""
