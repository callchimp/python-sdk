...
class TestInboundCallResponseHangupCause(unittest.TestCase):
    """InboundCallResponseHangupCause unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundCallResponseHangupCause:
        """Test InboundCallResponseHangupCause
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundCallResponseHangupCause`
        """
        model = InboundCallResponseHangupCause()
        if include_optional:
            return InboundCallResponseHangupCause(
            )
        else:
            return InboundCallResponseHangupCause(
        )
    ...
    def testInboundCallResponseHangupCause(self):
        """Test InboundCallResponseHangupCause"""
