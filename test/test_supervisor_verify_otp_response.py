...
class TestSupervisorVerifyOtpResponse(unittest.TestCase):
    """SupervisorVerifyOtpResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupervisorVerifyOtpResponse:
        """Test SupervisorVerifyOtpResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupervisorVerifyOtpResponse`
        """
        model = SupervisorVerifyOtpResponse()
        if include_optional:
            return SupervisorVerifyOtpResponse(
                message = ''
            )
        else:
            return SupervisorVerifyOtpResponse(
    ...
    def testSupervisorVerifyOtpResponse(self):
        """Test SupervisorVerifyOtpResponse"""
