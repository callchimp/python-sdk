...
class TestSubscribersPostRequest(unittest.TestCase):
    """SubscribersPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscribersPostRequest:
        """Test SubscribersPostRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscribersPostRequest`
        """
        model = SubscribersPostRequest()
        if include_optional:
            return SubscribersPostRequest(
                first_name = '',
                last_name = '',
                leadlist = 56,
                phone_code = '',
    ...
    def testSubscribersPostRequest(self):
        """Test SubscribersPostRequest"""
