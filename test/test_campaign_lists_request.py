...
class TestCampaignListsRequest(unittest.TestCase):
    """CampaignListsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignListsRequest:
        """Test CampaignListsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignListsRequest`
        """
        model = CampaignListsRequest()
        if include_optional:
            return CampaignListsRequest(
                name = '',
                phone_number = 56,
                type = '',
    ...
    def testCampaignListsRequest(self):
        """Test CampaignListsRequest"""
