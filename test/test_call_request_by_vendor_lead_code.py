...
class TestCallRequestByVendorLeadCode(unittest.TestCase):
    """CallRequestByVendorLeadCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallRequestByVendorLeadCode:
        """Test CallRequestByVendorLeadCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallRequestByVendorLeadCode`
        """
        model = CallRequestByVendorLeadCode()
        if include_optional:
            return CallRequestByVendorLeadCode(
                vendor_lead_code = ''
            )
        else:
            return CallRequestByVendorLeadCode(
    ...
    def testCallRequestByVendorLeadCode(self):
        """Test CallRequestByVendorLeadCode"""
