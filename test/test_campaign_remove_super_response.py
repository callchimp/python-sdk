...
class TestCampaignRemoveSuperResponse(unittest.TestCase):
    """CampaignRemoveSuperResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignRemoveSuperResponse:
        """Test CampaignRemoveSuperResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignRemoveSuperResponse`
        """
        model = CampaignRemoveSuperResponse()
        if include_optional:
            return CampaignRemoveSuperResponse(
                message = ''
            )
        else:
            return CampaignRemoveSuperResponse(
    ...
    def testCampaignRemoveSuperResponse(self):
        """Test CampaignRemoveSuperResponse"""
