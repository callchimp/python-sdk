...
class TestInboundCallResponseCallchimpNumber(unittest.TestCase):
    """InboundCallResponseCallchimpNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundCallResponseCallchimpNumber:
        """Test InboundCallResponseCallchimpNumber
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundCallResponseCallchimpNumber`
        """
        model = InboundCallResponseCallchimpNumber()
        if include_optional:
            return InboundCallResponseCallchimpNumber(
                id = 56,
                number = '',
                type = 'JIO'
            )
    ...
    def testInboundCallResponseCallchimpNumber(self):
        """Test InboundCallResponseCallchimpNumber"""
