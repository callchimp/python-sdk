...
class TestCampaignFindRequest(unittest.TestCase):
    """CampaignFindRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignFindRequest:
        """Test CampaignFindRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignFindRequest`
        """
        model = CampaignFindRequest()
        if include_optional:
            return CampaignFindRequest(
                query = ''
            )
        else:
            return CampaignFindRequest(
    ...
    def testCampaignFindRequest(self):
        """Test CampaignFindRequest"""
