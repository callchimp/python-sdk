...
class TestScriptsApi(unittest.TestCase):
    ...
    def test_scripts_delete(self) -> None:
        """Test case for scripts_delete

        Delete Script by Id
        """
        pass

    def test_scripts_get(self) -> None:
    ...
    def test_scripts_list(self) -> None:
        """Test case for scripts_list

        List Script
        """
        pass

    def test_scripts_post(self) -> None:
        """Test case for scripts_post

        Create a Script
        """
        pass

    def test_scripts_update(self) -> None:
        """Test case for scripts_update
