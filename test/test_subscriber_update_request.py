...
class TestSubscriberUpdateRequest(unittest.TestCase):
    """SubscriberUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriberUpdateRequest:
        """Test SubscriberUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriberUpdateRequest`
        """
        model = SubscriberUpdateRequest()
        if include_optional:
    ...
    def testSubscriberUpdateRequest(self):
        """Test SubscriberUpdateRequest"""
