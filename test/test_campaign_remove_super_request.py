...
class TestCampaignRemoveSuperRequest(unittest.TestCase):
    """CampaignRemoveSuperRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignRemoveSuperRequest:
        """Test CampaignRemoveSuperRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignRemoveSuperRequest`
        """
        model = CampaignRemoveSuperRequest()
        if include_optional:
            return CampaignRemoveSuperRequest(
                supervisors = [
                    56
                    ]
            )
    ...
    def testCampaignRemoveSuperRequest(self):
        """Test CampaignRemoveSuperRequest"""
