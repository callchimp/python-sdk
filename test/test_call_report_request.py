...
class TestCallReportRequest(unittest.TestCase):
    """CallReportRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallReportRequest:
        """Test CallReportRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallReportRequest`
        """
        model = CallReportRequest()
        if include_optional:
    ...
    def testCallReportRequest(self):
        """Test CallReportRequest"""
