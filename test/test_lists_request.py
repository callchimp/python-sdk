...
class TestListsRequest(unittest.TestCase):
    """ListsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListsRequest:
        """Test ListsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListsRequest`
        """
        model = ListsRequest()
        if include_optional:
            return ListsRequest(
