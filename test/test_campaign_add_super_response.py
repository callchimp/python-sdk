...
class TestCampaignAddSuperResponse(unittest.TestCase):
    """CampaignAddSuperResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignAddSuperResponse:
        """Test CampaignAddSuperResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignAddSuperResponse`
        """
        model = CampaignAddSuperResponse()
        if include_optional:
            return CampaignAddSuperResponse(
                message = ''
            )
        else:
            return CampaignAddSuperResponse(
    ...
    def testCampaignAddSuperResponse(self):
        """Test CampaignAddSuperResponse"""
