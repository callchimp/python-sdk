...
class TestInboundCallResponseSupervisor(unittest.TestCase):
    """InboundCallResponseSupervisor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundCallResponseSupervisor:
        """Test InboundCallResponseSupervisor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundCallResponseSupervisor`
        """
        model = InboundCallResponseSupervisor()
        if include_optional:
            return InboundCallResponseSupervisor(
                id = 56,
                name = '',
                phone = '',
                priority = 56
    ...
    def testInboundCallResponseSupervisor(self):
        """Test InboundCallResponseSupervisor"""
